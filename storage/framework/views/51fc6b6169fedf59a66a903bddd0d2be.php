...
<?php $__env->startSection('title', 'Modifier Professeur'); ?>
<?php $__env->startSection('subtitle', $professeur->nom_complet); ?>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('admin.professeurs.update', $professeur)); ?>" method="POST">
...
unset($__errorArgs, $__bag); ?>"
                                   id="matricule" name="matricule" value="<?php echo e(old('matricule', $professeur->matricule)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" id="nom" name="nom"
                                   value="<?php echo e(old('nom', $professeur->nom)); ?>" required>
                        </div>
                        <div class="col-md-4">
                            <label for="prenom" class="form-label">Prénom <span class="text-danger">*</span></label>
                            <input type="text" class="form-control" id="prenom" name="prenom"
                                   value="<?php echo e(old('prenom', $professeur->prenom)); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                   value="<?php echo e(old('email', $professeur->email)); ?>" required>
                        </div>
                        <div class="col-md-6">
                            <label for="telephone" class="form-label">Téléphone</label>
                            <input type="text" class="form-control" id="telephone" name="telephone"
                                   value="<?php echo e(old('telephone', $professeur->telephone)); ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="specialite" name="specialite"
                               value="<?php echo e(old('specialite', $professeur->specialite)); ?>">
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control <?php $__errorArgs = ['max_heures_mensuel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                   ...
                                   value="<?php echo e(old('max_heures_mensuel', $professeur->max_heures_mensuel)); ?>"
                                   min="1" max="200"
                                   placeholder="Ex: 40 (vide = pas de limite)">
                            <?php $__errorArgs = ['max_heures_mensuel'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?><div class="invalid-feedback"><?php echo e($message); ?></div><?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row mb-3">
                        <div class="col-12">
                            <label class="form-label">Heures utilisées ce mois (<?php echo e(\App\Models\EmploiDuTemps::formatHeures($heuresActuelles)); ?> / <?php echo e(\App\Models\EmploiDuTemps::formatHeures($maxHeures)); ?>)</label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <select name="modules[]" id="modules" class="form-select <?php $__errorArgs = ['modules'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="groupes[]" id="groupes" class="form-select <?php $__errorArgs = ['groupes'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" multiple size="6">
                                <?php $__currentLoopData = $groupes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $groupe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($groupe->id); ?>" 
                                        ...
                                        <?php echo e($groupe->nom); ?> (<?php echo e($groupe->filiere->code ?? 'N/A'); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="filieres[]" id="filieres" class="form-select <?php $__errorArgs = ['filieres'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                    ...
                    <div class="mb-4">
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" id="actif" name="actif" value="1"
                                   <?php echo e(old('actif', $professeur->actif) ? 'checked' : ''); ?>>
                            <label class="form-check-label" for="actif">Professeur actif</label>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between">
                        <a href="<?php echo e(route('admin.professeurs.index')); ?>" class="btn btn-secondary">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\XAMPP1\htdocs\emploi-du-temps\resources\views/admin/professeurs/edit.blade.php ENDPATH**/ ?>