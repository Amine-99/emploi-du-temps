...
<?php $__env->startSection('actions'); ?>
    <?php if(request('view') === 'trashed'): ?>
        <a href="<?php echo e(route('admin.emplois.index')); ?>" class="btn btn-secondary me-2">
            <i class="bi bi-arrow-left me-2"></i> Voir les séances courantes
        </a>
    <?php else: ?>
        <a href="<?php echo e(route('admin.emplois.index', ['view' => 'trashed'])); ?>" class="btn btn-warning me-2">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\emploi-du-temps\resources\views/admin/emplois/index.blade.php ENDPATH**/ ?>