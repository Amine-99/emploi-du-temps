                        ...
                        <div class="col-md-4 mb-3">
                            <div class="p-3 border rounded bg-light">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <span class="fw-bold"><?php echo e($module->nom); ?></span>
                                    <span class="badge bg-primary"><?php echo e($module->progress_syllabus); ?>%</span>
                                </div>
                                ...
                                <div class="mt-2 d-flex justify-content-between align-items-center small text-muted">
                                    <span><?php echo e($module->syllabusItems->count()); ?> chapitres définis</span>
                                    <?php
                                        $heuresTotales = $module->max_heures_mensuel;
                                        $heuresConsommees = $module->getHeuresMensuellesActuelles();
                                    ?>
                                    <?php if($heuresTotales > 0 && ($heuresConsommees / $heuresTotales) >= 0.9): ?>
                                        <span class="badge bg-danger rounded-pill" title="Masse horaire presque épuisée">
                                            <i class="bi bi-alarm pe-1"></i> <?php echo e(\App\Models\EmploiDuTemps::formatHeures($heuresConsommees)); ?> / <?php echo e(\App\Models\EmploiDuTemps::formatHeures($heuresTotales)); ?>

                                        </span>
                                    <?php elseif($heuresTotales > 0): ?>
                                        <span><?php echo e(\App\Models\EmploiDuTemps::formatHeures($heuresConsommees)); ?> / <?php echo e(\App\Models\EmploiDuTemps::formatHeures($heuresTotales)); ?></span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.professeur', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\emploi-du-temps\resources\views/professeur/dashboard.blade.php ENDPATH**/ ?>