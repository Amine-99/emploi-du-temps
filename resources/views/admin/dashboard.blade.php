            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['groupes'] }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['professeurs'] }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['etudiants'] }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $stats['absences'] }}</div>
                    </div>
                    <div class="col-auto">
    ...
    <div class="col-lg-12 mb-4">
        <div class="card border-left-warning shadow">
            <div class="card-header py-3 bg-warning bg-opacity-10 d-flex justify-content-between align-items-center">
                ...
                <span class="badge bg-warning text-dark">{{ count($demandesAnnulation) }} demande(s)</span>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover" width="100%" cellspacing="0">
                        ...
                        <tbody>
                            @foreach($demandesAnnulation as $demande)
                                <tr>
                                    <td><strong>{{ $demande->professeur->nom_complet }}</strong></td>
                                    <td>{{ $demande->module->nom }}<br><small class="text-muted">{{ $demande->groupe->nom }}</small></td>
                                    <td>{{ $demande->jour }}<br><small class="text-muted">{{ $demande->heure_debut }} - {{ $demande->heure_fin }}</small></td>
                                    <td><em class="text-danger">"{{ $demande->motif_annulation }}"</em></td>
                                    <td>
                                        <div class="d-flex gap-2">
                                            <form action="{{ route('admin.emplois.approve', $demande->id) }}" method="POST">
                                                @csrf
                                                <button type="submit" class="btn btn-sm btn-success">
                                                    <i class="bi bi-check-circle me-1"></i>Approuver
                                                </button>
                                            </form>
                                            <form action="{{ route('admin.emplois.reject', $demande->id) }}" method="POST">
                                                @csrf
                        ...
                        <tbody>
                            @forelse($dernieresSeances as $seance)
                                <tr>
                                    ...
                                    <td>{{ $seance->module->nom ?? 'N/A' }}</td>
                                    <td>{{ $seance->professeur->nom_complet ?? 'N/A' }}</td>
