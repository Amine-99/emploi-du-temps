...
@section('subtitle', 'Ajouter une nouvelle filière')
    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-plus-circle me-2"></i>Informations de la filière</h5>
            </div>
            <div class="card-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control @error('code') is-invalid @enderror"
                                   ...
                                   placeholder="Ex: DD, TRI" required>
                            @error('code')
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('duree_formation') is-invalid @enderror"
                                ...
                                <option value="1" {{ old('duree_formation') == 1 ? 'selected' : '' }}>1 an</option>
                                <option value="2" {{ old('duree_formation', 2) == 2 ? 'selected' : '' }}>2 ans</option>
                                <option value="3" {{ old('duree_formation') == 3 ? 'selected' : '' }}>3 ans</option>
                            </select>
