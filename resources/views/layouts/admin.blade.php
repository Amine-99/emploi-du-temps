    ...
    <div class="d-flex">
        ...
        <nav class="sidebar">
            <div class="logo-section">
                <img src="{{ asset('OFPPT_Logo.png') }}" alt="Logo" class="img-fluid mb-2" style="max-height: 50px;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.professeurs.index') ? 'active' : '' }}" href="{{ route('admin.professeurs.index') }}">
                        <i class="bi bi-person-badge"></i> Professeurs
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.professeurs.paie') ? 'active' : '' }}" href="{{ route('admin.professeurs.paie') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.examens.*') ? 'active' : '' }}" href="{{ route('admin.examens.index') }}">
                        <i class="bi bi-calendar-check"></i> Examens
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.annonces.*') ? 'active' : '' }}" href="{{ route('admin.annonces.index') }}">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.emplois.index') ? 'active' : '' }}" href="{{ route('admin.emplois.index') }}">
                        <i class="bi bi-calendar3"></i> Liste des séances
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.emplois.grille') ? 'active' : '' }}" href="{{ route('admin.emplois.grille') }}">
                        <i class="bi bi-grid-3x3"></i> Grille par groupe
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.emplois.grille-semaine') ? 'active' : '' }}" href="{{ route('admin.emplois.grille-semaine') }}">
